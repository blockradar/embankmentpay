...
import { mockBalance, mockTransactions } from "./data";
import { mockDelay } from "./delay";

export const depositMockAdapter: DepositService = {
  getBalance: () => mockDelay(mockBalance),
  getRecentTransactions: (limit = 5) => mockDelay(mockTransactions.slice(0, limit)),
  createStablecoinAddress: (network) =>
    mockDelay({
      id: "addr_mock_1",
